...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/06/22 23:52:54 by ael-mahm          #+#    #+#             */
/*   Updated: 2022/08/10 22:48:02 by ael-mahm         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	check_fn(t_data *obj, int i, int j, t_map *map_count)
{
	if (*(*(obj->map + i) + j) == 'E')
